  ...
  const demoServices = [
    {
      ...
      full_description: 'Главный корпус МГТУ им. Н.Э. Баумана - историческое здание, в котором расположены основные факультеты и администрация университета.'
    },
    {
      id: 2,
      ...
      full_description: 'Учебно-лабораторный корпус МГТУ им. Н.Э. Баумана оснащен современным оборудованием для проведения научных исследований.'
    },
    {
      id: 3,
      ...
      full_description: 'Спортивный комплекс МГТУ им. Н.Э. Баумана включает в себя бассейн, тренажерные залы, залы для игровых видов спорта.'
    }
  ];
    ...
    <div className="catalog-page">
      ...
      <section>
        <div className="container">
          <h1 className="page-title">Каталог строительных объектов</h1>
        </div>
      </section>
          ...
          {searchQuery && (
            <div className="search-results">
              {filteredServices.length > 0 ? (
                <p>Найдено результатов: {filteredServices.length} по запросу "{searchQuery}"</p>
              ) : (
