...
# НАСТРОЙКИ БАЗЫ ДАННЫХ - ИСПРАВЛЕНО НА SQLite
DATABASES = {
    'default': {
...
# Настройка сессий (упрощено для SQLite)
SESSION_ENGINE = "django.contrib.sessions.backends.db"  # Используем базу данных для сессий
