...
urlpatterns = [
    # API для элементов заявок (перемещено в начало)
    ...
    # API маршруты
    path('api/supervisions/draft/<int:pk>/', api_views.get_draft_supervision, name='get_draft_supervision'),
    ...
    # Остальные API для элементов заявок
